                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="POST"
                            action="{{ route('documento.update', $doc) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Ingrese el nombre" type="text" class="form-control" id="nombre"
                                    name="nombre" aria-describedby="nombreHelp" value="{{ old('nombre', $doc->nombre) }}"
                                    required>
                                @error('nombre')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="tipo_id">
                                    ...
                                    @foreach ($tipos as $tipo)
                                        <option value="{{ $tipo->id }}" {{ (old('tipo_id', $doc->tipo_documento_id) == $tipo->id) ? 'selected' : '' }}>{{ $tipo->nombre }}</option>
                                    @endforeach
                                </select>
                                @error('tipo_id')
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="cliente_id">
                                    ...
                                    @foreach ($clientes as $cliente)
                                        <option value="{{ $cliente->id }}" {{ (old('cliente_id', $doc->clientes_id ) == $cliente->id ) ? 'selected' : '' }} >{{ $cliente->nombre }}</option>
                                    @endforeach
                                </select>
                                @error('cliente_id')
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="departamento_id">
                                    ...
                                    @foreach ($departamentos as $departamento)
                                        <option value="{{ $departamento->id }}" {{ (old('departamento_id',$doc->departamento_id) == $departamento->id) ? 'selected' : ''}} >{{ $departamento->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Ingrese el formato" type="text" class="form-control" id="formato"
                                    ...
                                    value="{{ old('formato', $doc->formato) }}" required>
                                @error('formato')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Ingrese el size" type="text" class="form-control" id="size"
                                    ...
                                    value="{{ old('size', $doc->size) }}" required>
                                @error('size')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="ingrese el remitente" type="text" class="form-control" id="remitente"
                                    ...
                                    value="{{ old('remitente', $doc->remitente) }}" required>
                                @error('remitente')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
